...
test('service-worker activation removes an old shell and retains IndexedDB data', async ({ browser }, testInfo) => {
  await withFreshContext(browser, testInfo, async ({ page }) => {
